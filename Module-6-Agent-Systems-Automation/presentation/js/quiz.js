/**
 * Quiz System
 * Система тестирования знаний по AI агентам и автоматизации
 */
...
class MultiQuiz {
  ...
  showResults() {
    ...
    if (percentage >= 90) {
      message = 'Отлично! Вы прекрасно усвоили материал по AI агентам!';
      emoji = '🎉';
    } else if (percentage >= 70) {
      message = 'Хорошо! Вы хорошо понимаете материал.';
      emoji = '👍';
